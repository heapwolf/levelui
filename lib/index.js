...
module.exports = function(opts) {
  ...
  wss.on('connection', function(ws) {
    ...
    function editorUpdate(key, dbname, request) {
    ...
    websocket.on('data', function(message) {
      ...
      if (request === 'keyListUpdate') {
        ...
        editorUpdate(value, dbname, 'editorUpdate');
      }
      ...
      else if (request === 'vis-fetch') {
        vis.fetch(value, db, write);
      }
      else if (request === 'vis-delete') {
        vis.del(value, db, write);
      }
