      ...
      levelup(userlocation, levelopts, function(error, usrdb) {
        ...
        wss.on('connection', function(ws) {
          ...
          function buildStackedAreaChart(opts) {
            ...
            var pathToValue = opts.pathToDate.split('.');
            var metadata = {};
            ...
            db['tagdb']
              ...
              .on('data', function(data) {
                ...
                var date = Date.parse(getValue(pathToDate, data.value));
                var value = getValue(pathToValue, data.value);
