...
var db = {};
var authpath = path.join(__dirname, '..', 'auth');
  ...
  levelup(sysdb, levelopts, function(error, sysdb) {
    ...
    levelup(tagdata, levelopts, function(error, tagdb) {
      ...
      levelup(userlocation, levelopts, function(err, usrdb) {
        ...
        tlsserver.listen(opts.tcp, function() {
          console.log('tls server listening on %d', opts.tcp);
        });
        ...
        var wss = new WebSocketServer({
          server: httpsserver.listen(opts.https, function() {
            console.log('https server listening on %d', opts.https);
          })
        });
