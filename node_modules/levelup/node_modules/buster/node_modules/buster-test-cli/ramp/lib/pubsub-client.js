 ...
 function (m) {
    ...
    function PubSubClient(opts) {
        if (opts._fayeClient) {
            ...
            this._serverHost = opts.host || "0.0.0.0";
    ...
    var bcsPubSubClient = PubSubClient.prototype = {
        create: function (opts) {
            var instance = new PubSubClient(opts);
        ...
        inherit: function (contextPath) {
            ...
            var pubsubClient = bcsPubSubClient.create({
